...
export default function AboutMe() {
    return (
        <div className={styles.aboutMeBox}>
            ...
            <p className={styles.aboutMeTextP}>2019 yılında Gazi Üniversitesi Matematik Bölümü'nde eğitimime başladım. Küçük yaştan itibaren bilgisayarlara karşı büyük bir ilgi ve yetenek geliştirdim ve bu tutkum beni yazılım alanında kariyer yapma yönünde motive etti. Şu anda JavaScript üzerinde çalışıyor ve bu alandaki gelişmeleri yakından takip ediyorum. Hedefim, profesyonel hayatımda Front End Web Developer olarak başarılı bir kariyer inşa etmek.
